    ...
    with st.spinner("Wait for it..."):
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                with col1:
                    st.markdown(f'<div class="recommendation-item">{recommendations[0]}</div>', unsafe_allow_html=True)
                    st.markdown(f'<div class="recommendation-item">{recommendations[1]}</div>', unsafe_allow_html=True)
                with col2:
                    st.markdown(f'<div class="recommendation-item">{recommendations[2]}</div>', unsafe_allow_html=True)
                    st.markdown(f'<div class="recommendation-item">{recommendations[3]}</div>', unsafe_allow_html=True)
